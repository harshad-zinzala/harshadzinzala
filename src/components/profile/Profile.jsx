      ...
      <div className="flex max-md:flex-col justify-between items-center gap-6">
        ...
        <div className="max-sm:w-full w-[33rem]">
          ...
          >
            ...
            <p className="mt-3">
              Passionate and results-driven Web Designer with 3 years of experience in designing, developing, and maintaining responsive websites and web applications.
            </p>
          </div>
